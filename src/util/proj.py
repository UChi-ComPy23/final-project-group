...
Note:
These projection operators are included mainly for completeness and future extensibility:
most methods in this project rely on proximal operators rather than explicit projections, 
many constrained or cone-based algorithms (e.g., mirror descent, 
projected gradient, feasibility schemes, ADMM with indicator penalties) require projection 
onto convex sets. Providing these operators makes the toolbox flexible for future algorithms.
"""
